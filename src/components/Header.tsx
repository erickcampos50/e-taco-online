      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-2xl font-bold">e-TACO 4ª Edição</h1>
              <p className="text-xs text-primary-200">Tabela Brasileira de Composição de Alimentos facilitada para estudantes</p>
            </div>
          </div>
          ...
          <nav className="flex flex-wrap items-center justify-center gap-4">
            <div className="relative">
              ...
              <button className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-primary-600 hover:bg-primary-500 transition-colors">
                <Upload size={20} />
                <span className="hidden sm:inline">Abrir prescrição</span>
              </button>
            </div>
            <button
            ...
            >
              <Download size={20} />
              <span className="hidden sm:inline">Salvar prescrição</span>
            </button>
            <button
